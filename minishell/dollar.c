...
/*   Updated: 2023/10/10 01:36:08 by fgolino          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_dollar(char *str)
{
	...
	while (str && str[i])
	{
		...
		else if (str[i] == '$' && str[i + 1] != ' ') //bisogna aggiungere il check se dopo il dollare c'è ? ($?) e in caso rimandare a l'ultimo exit_status se c'è
			return (i);
		i++;
	}
	return (-1);
